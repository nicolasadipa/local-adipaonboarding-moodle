...
$string['step_adipainfo_body'] = 'Sesiones, evaluaciones y certificación, organizadas con claridad. Te avisamos siempre cuál es tu próxima fecha clave para que nada se te escape.';
...
$string['step_certification_body'] = 'Al completar tu programa, podrás descargar tu certificación desde aquí. Cada paso que das te acerca un poco más a este logro.';
$string['step_nid_title'] = 'Tu documento de identidad';
$string['step_nid_body']  = 'Antes de tu certificación, sube tu documento de identidad. Es un paso clave para que tu certificado salga con tus datos correctos.';

// Acreditacion: tile especial de Documentacion.
...
// Botón de reactivación + UI Driver.js.
...
// Tour editor — reset + override modal.
...
// Restricted courses (limitar tour a cursos especificos durante testing).
...
// Tour mod_adipavideo (reproductor de cápsulas).
...
$string['video_step_transcript_title'] = 'Buscá cualquier palabra del video';
$string['video_step_transcript_body']  = 'La transcripción completa está disponible y es buscable. Si querés repasar un concepto, escribilo en el buscador y saltás directo a ese minuto.';
...
$string['video_step_progress_body']  = 'La barra superior muestra cuánto avanzaste del programa. Cada cápsula completada suma — y te acerca a tu certificación.';
